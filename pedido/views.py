...
class DispatchLoginRequiredMixin(View):
    ...
    def get_queryset(self, *args, **kwargs):
        ...
        qs.filter(usuario=self.request.user)
...
class SalvarPedido(View):
    ...
    def get(self, *args, **kwargs):
        ...
        # Pega o id dos itens do carrinho
        carrinho_variacao_ids = [v for v in carrinho]
        print(f'Carrinho ids {carrinho_variacao_ids}')

        # Usa as variacoes do carrrinho para buscar os itens no banco
        bd_variacoes = list(Variacao.objects.select_related('produto').filter(
            id__in=carrinho_variacao_ids))
        print(f'bd_variacoes {bd_variacoes}')

        # Compara cada produto do carrinho com a quantidade em estoque
